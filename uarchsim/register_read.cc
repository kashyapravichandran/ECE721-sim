...
void pipeline_t::register_read(unsigned int lane_number) {
   ...
   if (Execution_Lanes[lane_number].rr.valid) {
	  ...
	  //unsigned int destination_reg = PAY.buf[index].C_phys_reg;
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//bool A_valid=PAY.buf[index].A_valid, B_valid=PAY.buf[index].B_valid, D_valid=PAY.buf[index].D_valid;
		//unsigned int A_phys_reg=PAY.buf[index].A_phys_reg, B_phys_reg=PAY.buf[index].B_phys_reg, D_phys_reg=PAY.buf[index].D_phys_reg;
